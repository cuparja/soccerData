...
if __name__ == '__main__':
    ...
    dirs = ['2017-2018 La Liga Stats',
            '2018-2019 La Liga Stats',
            '2019-2020 La Liga Stats',
            '2020-2021 La Liga Stats',
            '2021-2022 La Liga Stats',
            '2017-2018 Serie A Stats',
            '2018-2019 Serie A Stats',
            '2019-2020 Serie A Stats',
            '2020-2021 Serie A Stats',
            '2021-2022 Serie A Stats',
            '2017-2018 Ligue 1 Stats',
            '2018-2019 Ligue 1 Stats',
            '2019-2020 Ligue 1 Stats',
            '2020-2021 Ligue 1 Stats',
            '2021-2022 Ligue 1 Stats',
            '2017-2018 Premier League Stats',
            '2018-2019 Premier League Stats',
            '2019-2020 Premier League Stats',
            '2020-2021 Premier League Stats',
            '2021-2022 Premier League Stats',
            '2017-2018 Bundesliga Stats',
            '2018-2019 Bundesliga Stats',
            '2019-2020 Bundesliga Stats',
            '2020-2021 Bundesliga Stats',
